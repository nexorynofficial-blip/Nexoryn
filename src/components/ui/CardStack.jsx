...
function DefaultFanCard({ item }) {
  return (
    <div className="flex h-full w-full flex-col overflow-hidden rounded-2xl border border-white/15 bg-white/5 backdrop-blur-xl">
      <div className="min-h-0 flex-1 p-5">
        <div className="h-full w-full overflow-hidden rounded-xl">
          {item.imageSrc ? (
            ...
            <div className="flex h-full w-full items-center justify-center bg-white/5 text-sm text-body-dim">
              No image
            </div>
          )}
        </div>
      ...
      <div className="px-5 pb-5">
        ...
        {item.description ? (
          <div className="mt-1 truncate text-sm font-normal text-white/70">{item.description}</div>
        ) : null}
      </div>
    </div>
  );
